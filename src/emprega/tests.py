...
from emprega.factories import UserFactory, EmpresaFactory, EnderecoFactory
...
class AdminUserTestCase(APITestCase):
    ...
    def test_self_delete(self):
        ...
        if self.self_delete_status and self.self_delete_status != status.HTTP_204_NO_CONTENT:
            return
...
class AdminEmpregadorTestCase(APITestCase):
    ...
    def test_create(self):
        ...
        self.assertEqual(json_response['tipo_deficiencia'], data['tipo_deficiencia'])
        ...
        self.assertEqual(json_response['numero_funcionarios'], data['numero_funcionarios'])
