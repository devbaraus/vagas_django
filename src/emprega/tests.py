...
from emprega.factories import UserFactory
from emprega.models import UsuarioNivelChoices, User, Empregador, Candidato
...
class AdminUserTestCase(APITestCase):
    ...
    def test_create(self):
        ...
        self.assertEqual(response.status_code, self.create_status or status.HTTP_201_CREATED)

        if self.create_status != status.HTTP_201_CREATED:
            return
    ...
    def test_retrieve(self):
        ...
        self.assertEqual(response.status_code, self.retrieve_status or status.HTTP_200_OK)

        if self.retrieve_status != status.HTTP_200_OK:
            return
    ...
    def test_detail(self):
        ...
        if self.detail_status != status.HTTP_200_OK:
            return
        ...
        self.assertEqual(json_response['data_nascimento'], user.data_nascimento.strftime('%Y-%m-%d'))
    ...
    def test_update(self):
        ...
        if self.update_status != status.HTTP_200_OK:
            return
    ...
    def test_delete(self):
        ...
        self.assertEqual(response.status_code, self.delete_status or status.HTTP_204_NO_CONTENT)

        if self.delete_status != status.HTTP_204_NO_CONTENT:
            return
    ...
    def test_self_detail(self):
        ...
        self.assertEqual(response.status_code, self.self_detail_status or status.HTTP_200_OK)

        if self.self_detail_status != status.HTTP_200_OK:
            return
        ...
        self.assertEqual(json_response['data_nascimento'], self.user.data_nascimento.strftime('%Y-%m-%d'))
    ...
    def test_self_update(self):
        ...
        self.assertEqual(response.status_code, self.self_update_status or status.HTTP_200_OK)

        if self.self_update_status != status.HTTP_200_OK:
            return
    ...
    def test_self_delete(self):
        ...
        self.assertEqual(response.status_code, self.self_delete_status or status.HTTP_204_NO_CONTENT)

        if self.self_delete_status != status.HTTP_204_NO_CONTENT:
            return
...
class AdminEmpregadorTestCase(APITestCase):
    ...
    def test_delete(self):
        ...
        self.assertEqual(Empregador.objects.count(), 1)
