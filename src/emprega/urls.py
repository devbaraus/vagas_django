...
from emprega.views import (
    EmpresaViews,
    CandidaturaViews,
    ObjetivoProfissionalViews,
    IdiomaViews,
    CursoEspecializacaoViews,
    FormacaoAcademicaViews,
    ExperienciaProfissionalViews,
    EnderecoViews,
    VagaViews,
    EmpregadorViews,
    CandidatoViews,
...
router.register(
    "objetivo_profissional", ObjetivoProfissionalViews, basename="objetivo_profissional"
)
router.register("idioma", IdiomaViews, basename="idioma")
router.register(
    "curso_especializacao", CursoEspecializacaoViews, basename="curso_especializacao"
)
router.register(
    "formacao_academica", FormacaoAcademicaViews, basename="formacao_academica"
)
router.register(
    "experiencia_profissional",
    ExperienciaProfissionalViews,
    basename="experiencia_profissional",
)
router.register("endereco", EnderecoViews, basename="endereco")
router.register("beneficio", BeneficioViews, basename="beneficio")
